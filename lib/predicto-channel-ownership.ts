...
export const CHANNEL_OWNERSHIP: ChannelOwnershipConfig[] = [
  ...
  {
    customer_id: '9308336690',
    account_name: 'Predicto - EST - 54',
    channel_ids: [],
  },
  {
    customer_id: '4337848325',
    account_name: 'Predicto - EST - 55',
    channel_ids: [],
  },
  {
    customer_id: '8737177088',
    account_name: 'Predicto - EST - 56',
    channel_ids: [],
  },
  {
    customer_id: '5929198423',
    account_name: 'Predicto - EST - 57',
    channel_ids: [],
  },
  {
    customer_id: '5139969741',
    account_name: 'Predicto - EST - 58',
    channel_ids: [],
  },
  {
    customer_id: '2533179401',
    account_name: 'Predicto - EST - 59',
    channel_ids: [],
  },
  {
    customer_id: '8167129629',
    account_name: 'Predicto - EST - 60',
    channel_ids: [],
  },
  {
    customer_id: '3540908401',
    account_name: 'Predicto - EST - 61',
    channel_ids: [],
  },
];
